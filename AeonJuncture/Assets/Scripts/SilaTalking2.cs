...
public class SilaTalking2 : MonoBehaviour
{
		...
		void Start ()
		{
				...
				text = 0;
				textContent.text = "\toh... there you are! \n\tThis is a swamp area, take care and avoid the black mud.";
				textContent.image = textbox;
		
				showInitHint = false;
				initHintText = "\tHave some caution with the 8 legged things. \n\tUse two fingers if you need my help to protect from web spits...";
