...
public class DoorTalk : MonoBehaviour
{
		...
		void Start ()
		{
				...
				text = 0;
				if (this.transform.tag == "DoorTalk1")
						textContent.text = "\tI'm the first door. \n\tI'm leading to death.";
				else if (this.transform.tag == "DoorTalk2")
						textContent.text = "\tI'm the second door. \n\tI'm leading to death.";
				else if (this.transform.tag == "DoorTalk3")
						textContent.text = "\tI'm the third door. \n\tI can guarantee that the second door is lying.";
