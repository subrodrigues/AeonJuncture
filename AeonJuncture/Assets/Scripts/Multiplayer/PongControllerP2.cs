...
public class PongControllerP2 : MonoBehaviour
{
	...
	void ApplyDamagePongP2 (float damage)
	{
		healthP2 -= damage;
		if (life == 0 && healthP2 <= 0.0f && !death) {
			...
			GameObject.FindGameObjectWithTag ("MainCamera").SendMessage ("TurnPlayer1Won", true, SendMessageOptions.DontRequireReceiver);
			death = true;
		}
